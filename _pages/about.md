...
<table border="0"bordercolor="white">
  <tr>
    <td> <font color="#0b5394"> Speech Processing </font>:<p> Speaker recognition and verification; Speech separation </td>
    <td> - <font color="#0b5394"> Computer Vision </font>:<p> Face recognition; Face detection; Lip reading</td>
  </tr>
  <tr>
    <td> - <font color="#0b5394"> Multi-modal Processing </font>:<p> Audio-visual active speaker detection</td>
    <td> - <font color="#0b5394"> Self-supervised Learning </font>:<p> Self-supervised speech processing </td>
  </tr>
</table>
